...
import NewsFeedRow from './NewsFeedRowOld';
import { withStyles } from '@material-ui/core/styles';

import styles from '../../assets/styles/components/articles/NewsFeedOld.js';
...
class NewsFeed extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            homeScreenNewsFeedRows: [newsFeedDictionary.QUERY_TOPARTICLES, newsFeedDictionary.QUERY_POLITICSARTICLES, newsFeedDictionary.QUERY_TOPARTICLES, newsFeedDictionary.QUERY_TOPARTICLES, newsFeedDictionary.QUERY_TOPARTICLES],
        }
    }
