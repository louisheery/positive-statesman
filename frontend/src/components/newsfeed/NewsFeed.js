...
const newsFeedDictionary = {
    ...
    QUERY_ECONARTICLES: ['economics', 'Economy, Business & Finance', { category: 'iptc-subjectcode04000000', limit: 6, offset: 0, sentiment_score_min: 0.8 }],
    ...
    QUERY_POLITICSARTICLES: ['politics', 'Politics', { category: 'iptc-subjectcode11000000', limit: 6, offset: 0, sentiment_score_min: 0.8 }],
    ...
    QUERY_SPORTARTICLES: ['sport', 'Sport', { category: 'iptc-subjectcode15000000', limit: 6, offset: 0, sentiment_score_min: 0.8 }],
    ...
    QUERY_WEATHERARTICLES: ['weather', 'Weather', { category: 'iptc-subjectcode17000000', limit: 6, offset: 0, sentiment_score_min: 0.8 }],
}
