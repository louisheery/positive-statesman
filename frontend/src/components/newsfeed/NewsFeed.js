...
class NewsFeed extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            newsFeedDictionary: {
                QUERY_TODAY: ['', 'Trending Today', { category: this.props.categoryId, limit: 6, offset: 0, sentiment_score_min: 0.5 }],
                QUERY_THISWEEK: ['', 'Trending This Week', { category: this.props.categoryId, limit: 6, offset: 0, sentiment_score_min: 0.5 }],
                QUERY_THISMONTH: ['', 'Trending This Month', { category: this.props.categoryId, limit: 6, offset: 0, sentiment_score_min: 0.5 }],
                QUERY_ALLTIME: ['', 'Trending All Time', { category: this.props.categoryId, limit: 6, offset: 0, sentiment_score_min: 0.5 }],
                QUERY_USA: ['', 'Trending in USA', { category: this.props.categoryId, limit: 6, offset: 0, sentiment_score_min: 0.5 }],
